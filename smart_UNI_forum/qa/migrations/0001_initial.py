    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('labels', models.CharField(choices=[(b'help_wanted', b'Help Wanted'), (b'idea', b'Idea'), (b'something_interesting', b'Something Interesting')], max_length=50)),
                ...
                ('created', models.DateTimeField(auto_now_add=True, verbose_name='date published')),
                ('modified', models.DateTimeField(auto_now=True, verbose_name='date updated')),
                ('attachment', models.ImageField(blank=True, upload_to='images/')),
